...
import pytest
from use_registered_email import use_registered_email_address
...
editions_ev = ['https://www.insideevs.com/', 'https://insideevs.fr/', 'https://insideevs.it/', 'https://insideevs.uol.com.br/',
               'https://insideevs.de/', 'https://insideevs.com.tr/', 'https://insideevs.com.ar/']

editions_other = ['https://www.rideapart.com/'  ]
